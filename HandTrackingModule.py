...
class HandDetector():
    def __init__(self, mode = False , maxHands = 2 ,modelComplexity = 1,  detection_confidence = 0.5 , tracking_confidence = 0.5):
        self.mode = mode
        ...
        self.hands = self.mpHands.Hands(self.mode,self.maxHands,self.modelComplexity ,self.detection_confidence ,self.tracking_confidence)
        # hands is the object
